...
const Dashboard: React.FC<DashboardProps> = React.memo(({ stats, schoolId }) => {
  ...
  const metricCards = [
    ...
    { label: 'Total Parents', val: stats.totalParents, icon: 'fa-people-roof', color: 'text-brand-600', bg: 'bg-brand-50', layout: 'sm:col-start-1 sm:row-start-2' },
    { label: 'Total Teachers', val: stats.totalTeachers, icon: 'fa-chalkboard-teacher', color: 'text-brand-500', bg: 'bg-brand-50', layout: 'sm:col-start-2 sm:row-start-1' },
    { label: 'Student Service', val: stats.totalStudentServices, icon: 'fa-user-gear', color: 'text-brand-600', bg: 'bg-brand-50', layout: 'sm:col-start-1 sm:row-start-3' },
