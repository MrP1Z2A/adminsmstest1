  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-700 pb-20">
      <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-10">
        <div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-tighter">Teacher Registration Hub</h2>
          <p className="text-sm text-slate-400 font-bold uppercase tracking-[0.3em] mt-3">Faculty Onboarding Suite</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="bg-white dark:bg-slate-900 p-8 sm:p-10 lg:p-12 rounded-[36px] sm:rounded-[48px] lg:rounded-[64px] shadow-premium border border-slate-100 dark:border-slate-800 text-center space-y-6 sm:space-y-8">
          ...
          <h4 className="text-2xl sm:text-3xl font-black tracking-tight">Register Teacher</h4>
          <p className="text-slate-400 text-sm font-semibold max-w-xs mx-auto">Create a teacher account and initialize access credentials.</p>
          <button
        ...
        <div className="bg-white dark:bg-slate-900 p-8 sm:p-10 lg:p-12 rounded-[36px] sm:rounded-[48px] lg:rounded-[64px] shadow-premium border border-slate-100 dark:border-slate-800 text-center space-y-6 sm:space-y-8">
          ...
          <h4 className="text-2xl sm:text-3xl font-black tracking-tight">Batch Teacher Registration</h4>
